...
define(['exports', 'aurelia-logging', 'aurelia-pal', 'aurelia-task-queue', 'aurelia-metadata'], function (exports, _aureliaLogging, _aureliaPal, _aureliaTaskQueue, _aureliaMetadata) {
  ...
  var CallFunction = exports.CallFunction = function (_Expression12) {
    ...
    CallFunction.prototype.evaluate = function evaluate(scope, lookupFunctions, mustEvaluate) {
      var func = this.method.evaluate(scope, lookupFunctions);
    ...
    CallFunction.prototype.connect = function connect(binding, scope) {
      this.method.connect(binding, scope);
      var func = this.method.evaluate(scope);
      if (typeof func === 'function') {
        var args = this.args;
        var _i9 = args.length;
        while (_i9--) {
  ...
  var ExpressionCloner = exports.ExpressionCloner = function () {
    ...
    ExpressionCloner.prototype.visitCallFunction = function visitCallFunction(call) {
      return new CallFunction(call.method.accept(this), this.cloneExpressionArray(call.args));
    };
